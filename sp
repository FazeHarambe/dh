...
local function PikaESP(v)
    ...
    game:GetService("RunService").RenderStepped:Connect(function()
        if v.Character ~= nil and v.Character:FindFirstChild("Humanoid") ~= nil and v.Character:FindFirstChild("HumanoidRootPart") ~= nil and v ~= lplr and v.Character.Humanoid.Health > 0 then
            ...
            if NiggaEspSet.Chams and v.Character.Head:FindFirstChild("Body") == nil then
            ...
            if onScreen then
                ...
                if NiggaEspSet.Tracers then
                    if NiggaEspSet.UnlockTracers then
                ...
                if NiggaEspSet.Name then
                    ...
                    Name.Visible = true
                    Name.Size = NiggaEspSet.TextSize
                    if NiggaEspSet.Font == "UI" then
                        Name.Font = 0
                        Gun.Font = 0
                    elseif NiggaEspSet.Font == "System" then
                        Name.Font = 1
                        Gun.Font = 1
                    elseif NiggaEspSet.Font == "Plex" then
                        Name.Font = 2
                        Gun.Font = 2
                    elseif NiggaEspSet.Font == "Monospace" then
                        Name.Font = 3
                        Gun.Font = 3
                    end
